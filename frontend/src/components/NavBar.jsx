...
const NavBar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-gray-200'>
      ...
      <ul className='hidden md:flex items-center list-none gap-5 font-medium'>
        <NavLink to='/'>
            ...
            <NavLink onClick={() => setShowMenu(false)} to='/contact'><p className='px-4 py-2 rounded inline-block'>CONTACT</p></NavLink>
            {
              token && (
                <>
                  ...
                  <p onClick={() => { setShowMenu(false); logout(); }} className='px-4 py-2 rounded inline-block cursor-pointer text-red-500'>LOGOUT</p>
                </>
              )
            }
          </ul>
